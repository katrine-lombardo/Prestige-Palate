...
def setup_tests():
    app.dependency_overrides[ReferralQueries] = lambda: FakeReferralQueries()
    app.dependency_overrides[authenticator.get_current_account_data] = lambda: fake_user_data
    yield
